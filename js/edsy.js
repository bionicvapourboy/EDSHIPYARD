...
window.edshipyard = new (function() {
    ...
    var CORE_SLOT_NAME = ["Bulkhead", "Power Plant", "Thruster", "Frame Shift Drive", "Life Support", "Power Distributor", "Sensors", "Fuel Tank"]; // TODO: remove while unused ?
    ...
    var CORE_ABBR_SLOT = { BH:0,PP:1,TH:2,FD:3,LS:4,PD:5,SS:6,FT:7,RB:1,TM:2,FH:3,EC:4,PC:5,FS:7};
